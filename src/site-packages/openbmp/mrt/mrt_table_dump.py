...
import os
import socket
import openbmp.mrt.bgp as bgp

from struct import pack
from openbmp.mrt.bmp import resolveIp
from openbmp.mrt.db_mysql import DbMySQL
    ...
    def do_dump(self, dump_timestamp):
        ...
        if peers:
            ...
            for peer in peers:
                ...
                # Peer is done, change filename to include file date
                os.rename(filename, filename + '.' + file_date)
